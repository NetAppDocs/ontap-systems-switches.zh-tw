...
[role="lead"]
在安裝RCF指令碼之前、請確定交換器上有下列項目：

* 已安裝Cummulis Linux 4.4.2。
...
* 叢集：* MSN2100-RCF-v1.8-叢集*
* 儲存設備：* MSN2100-RCF-v1.8-Storage*



NOTE: 下列程序範例說明如何下載及套用叢集的RCF指令碼。
...
----
. 套用RCF指令碼* MSN2100-RCF-v1.8-Cluster*：
+
[listing, subs="+quotes"]
----
...
----
. 確認每個節點都有連線至每個交換器：「net show LLDP」
+
[listing, subs="+quotes"]
----
