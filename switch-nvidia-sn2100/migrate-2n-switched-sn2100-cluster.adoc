...
IMPORTANT: 請參閱 link:cabling-considerations-sn2100-cluster.html["審查佈線和配置注意事項"] 以瞭解注意事項和更多詳細資料。link:https://hwu.netapp.com/SWITCH/INDEX["Hardware Universe- 交換機"^] 也包含有關佈線的更多資訊。
