...
IMPORTANT: 有關注意事項和更多詳情，請參閱 link:cabling-considerations-sn2100-cluster.html["檢閱佈線和組態指南"]。link:https://hwu.netapp.com/SWITCH/INDEX["Hardware Universe- 交換機"^] 也包含有關佈線的更多資訊。
