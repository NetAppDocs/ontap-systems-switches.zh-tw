...
[role="lead"]
請遵循此程序來設定支援交換器記錄收集和交換器健全狀況監控（SHM）的v3。
...
以下命令使用SHM建立了v3使用者名稱：「cluster1：：*>系統交換器乙太網路修改-DEVICE _DEVICE _-SNM-version v3 -community或-username_SNMPv3
...
----
====
. 確認新建立的v3使用者要查詢的序號與SHM輪詢期間完成後、上一步所述的序號相同。
+
