...
summary: 將現有的 NetApp CN1610 叢集交換器移轉至 NVIDIA SN2100 叢集交換器，而不中斷叢集運作。 
---
= 將 NetApp CN1610 叢集交換器移轉至 NVIDIA SN2100 叢集交換器
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
將現有的 NetApp CN1610 叢集交換器移轉至 NVIDIA SN2100 叢集交換器，而不中斷叢集運作。
