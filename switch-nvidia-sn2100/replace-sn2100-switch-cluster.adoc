...
summary: 更換叢集網路中故障的 NVIDIA SN2100 叢集交換器。此程序不中斷營運的服務。 
---
= 更換 NVIDIA SN2100 叢集交換器
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
在不中斷叢集運作的情況下，更換叢集網路中發生故障的 NVIDIA SN2100 叢集交換器。此不中斷營運的程序 （NDU） 包括準備替換交換器，並將連線從故障交換器移轉至新交換器。
