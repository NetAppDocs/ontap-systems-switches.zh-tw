...
summary: 依照下列工作流程在 ONTAP 環境中安裝和設定 NVIDIA SN2100 叢集交換器。 
---
= NVIDIA SN2100 叢集交換器的安裝與設定工作流程
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
請依照下列工作流程在 ONTAP 環境中安裝和設定 NVIDIA SN2100 叢集交換器。SN2100 是一款 10/25/40/100 GbE 交換器，執行 Cumulus Linux，支援包含兩個以上節點的 ONTAP 叢集。

請依照以下工作流程步驟安裝並設定您的 NVIDIA SN2100 交換器。
