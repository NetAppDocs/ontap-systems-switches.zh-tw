...
summary: 升級 Cisco Nexus 9808 交換器上的 NX-OS，以支援新硬體或 AFX 2K 系統上的新 ONTAP 版本。 
---
= 升級 Cisco Nexus 9808 交換器上的 NX-OS
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
升級 Cisco Nexus 9808 交換器上的 NX-OS，以支援新硬體或 AFX 2K 系統上的新 ONTAP 版本。
