...
summary: 在 Cisco Nexus 9808 交換器上安裝 NX-OS，用於新的 AFX 2K 系統安裝、監督模組更換或恢復原廠預設值。 
---
= 在 Cisco Nexus 9808 交換器上安裝 NX-OS
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
在 Cisco Nexus 9808 交換器上安裝 NX-OS，用於新的 AFX 2K 系統安裝、更換管理模組或將交換器重設為原廠預設值。
