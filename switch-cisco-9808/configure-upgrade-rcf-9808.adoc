...
summary: 您可以升級 Cisco Nexus 9808 交換器上的參考組態檔案 （RCF） 版本，以支援新硬體、新的 ONTAP 版本，或與 AFX 2K 系統組態中的新 NX-OS 版本保持一致。 
---
= 升級 RCF 版本 - Cisco Nexus 9808
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
您可以升級 Cisco Nexus 9808 交換器上的參考組態檔案 （RCF） 版本，以支援新硬體、新的 ONTAP 版本，或與 AFX 2K 系統組態中的新 NX-OS 版本保持一致。
