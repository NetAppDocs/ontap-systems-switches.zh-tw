...
summary: 在 Cisco Nexus 9336C-FX2 和 9336C-FX2-T 儲存設備交換器上安裝或升級 NX-OS 軟體。 
---
= 在 Cisco Nexus 9336C-FX2 儲存設備交換器上安裝或升級 NX-OS 軟體
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
在 Cisco Nexus 9336C-FX2 和 9336C-FX2-T 儲存設備交換器上安裝或升級 NX-OS 軟體。必須先安裝 NX-OS，才能設定交換器或安裝參考組態檔案 （RCF）。
...
----
====
. 交換器重新開機後，請再次登入並驗證新版本的 EPLD 是否已成功載入。
+
.顯示範例
[%collapsible]
====
...
----
====
. 如果您是第一次設定交換器，請跳至步驟 14。如果您要升級交換器，請繼續執行下一步。
