...
summary: 在安裝 NX-OS 軟體和參考組態檔案 （RCF） 之前，請準備好 Cisco Nexus 9336C-FX2 和 9336C-FX2-T 儲存設備交換器。 
---
= 準備在 Cisco Nexus 9336C-FX2 儲存交換器上安裝 NX-OS 軟體和 RCF
:allow-uri-read: 


[role="lead"]
在安裝 NX-OS 軟體和參考組態檔案 （RCF） 之前，請準備好 Cisco Nexus 9336C-FX2 和 9336C-FX2-T 儲存設備交換器。必須先安裝 NX-OS 和 RCF，交換器才能在 ONTAP 儲存網路中運作。
