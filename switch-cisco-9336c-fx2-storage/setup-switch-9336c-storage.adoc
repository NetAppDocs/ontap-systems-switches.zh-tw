...
.接下來呢？
您也可以選擇 link:install-switch-and-passthrough-panel-9336c-storage.html["在NetApp機櫃中安裝交換器"]。否則、請前往 link:install-nxos-overview-9336c-storage.html["準備安裝NX-OS和RCF"]。
