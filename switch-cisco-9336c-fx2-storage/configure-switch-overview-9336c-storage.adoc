...
summary: 依照下列工作流程在 ONTAP 環境中安裝並設定 Cisco Nexus 9336C-FX2 和 9336C-FX2-T 儲存設備交換器。 
---
= Cisco Nexus 9336C-FX2 和 9336C-FX2-T 儲存設備交換器的安裝和設定工作流程
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
請依照以下工作流程在 ONTAP 環境中安裝和設定 Cisco Nexus 9336C-FX2 和 9336C-FX2-T 儲存設備交換器。這些交換器是 Cisco Nexus 9000 平台的一部分，支援 ONTAP 系統的儲存網路連線。
