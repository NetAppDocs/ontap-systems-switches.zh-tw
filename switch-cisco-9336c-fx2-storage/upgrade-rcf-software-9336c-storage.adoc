...
summary: 當 Cisco Nexus 9336C-FX2 和 9336C-FX2-T 儲存設備交換器有更新版本時，請升級參考組態檔案（RCF）。 
---
= 升級 Cisco Nexus 9336C-FX2 和 9336C-FX2-T 儲存設備交換器上的 RCF
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
當 Cisco Nexus 9336C-FX2 和 9336C-FX2-T 儲存設備交換器有更新版本的 RCF 可用時，請升級參考組態檔案 （RCF）。
...
. 確認連接到節點儲存連接埠和儲存架連接埠的交換器連接埠為 *up*。
+
[source, cli]
----
