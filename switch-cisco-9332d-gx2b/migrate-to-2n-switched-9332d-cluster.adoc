...
** 請參閱 https://hwu.netapp.com["Hardware Universe"^]以取得所有支援的 ONTAP 版本。
...
+
如需佈線的詳細資訊、請參閱 https://hwu.netapp.com["Hardware Universe"^]。
...
請參閱  https://hwu.netapp.com["Hardware Universe"^] 以取得平台叢集連接埠的相關資訊。請參閱 link:https://kb.netapp.com/Support/General_Support/What_additional_information_do_I_need_to_install_my_equipment_that_is_not_in_HWU["安裝HWU中沒有的設備還需要哪些額外資訊？"^] 以取得交換器安裝需求的詳細資訊。
