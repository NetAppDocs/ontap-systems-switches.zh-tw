...
** 請參閱 https://hwu.netapp.com["Hardware Universe"^] 適用於所有支援ONTAP 的版本。
...
+
請參閱 https://hwu.netapp.com["Hardware Universe"^] 如需纜線的詳細資訊、
...
----
====
. 斷開節點 1 上叢集連接埠 e0a 的電纜，然後使用 9332D-GX2B 交換器支援的適當電纜將 e0a 連接到叢集交換器 cs1 上的連接埠 1。
+
