...
summary: 如果您正在將交換器設定為新的 AFX 1K 或 AFX 2K 系統安裝、交換器更換或恢復原廠預設設定的一部分，並且想要使用叢集交換器健康監視器 （CSHM） 和日誌收集功能，則必須確認交換器上是否已啟用 SSH 和 SSH 金鑰。 
---
= 驗證 SSH 日誌收集功能 - Cisco Nexus 9332D-GX2B
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
