...
summary: 您可以在 Cisco Nexus 9332D-GX2B 交換器上安裝 NX-OS，作為新 AFX 1K 或 AFX 2K 系統安裝、交換器更換或交換器重設為原廠預設值的一部分。 
---
= 安裝 NX-OS - Cisco Nexus 9332D-GX2B
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
您可以在 Cisco Nexus 9332D-GX2B 交換器上安裝 NX-OS，作為新 AFX 1K 或 AFX 2K 系統安裝、交換器更換或交換器重設為原廠預設值的一部分。
