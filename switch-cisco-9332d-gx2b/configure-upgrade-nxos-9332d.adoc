...
summary: 升級 Cisco Nexus 9332D-GX2B 交換器上的 NX-OS，以支援新硬體或 AFX 1K 或 AFX 2K 系統上的新 ONTAP 版本。 
---
= 升級 Cisco Nexus 9332D-GX2B 交換器上的 NX-OS
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
升級 Cisco Nexus 9332D-GX2B 交換器上的 NX-OS，以支援新硬體或 AFX 1K 或 AFX 2K 系統上的新 ONTAP 版本。
...
在第一個交換器 （cs1） 上安裝 NX-OS，方法是安裝並驗證 NX-OS 和 EPLD 的新版本，驗證叢集上所有連接埠的健全狀況，然後在第二個交換器 （cs2） 上重複這些步驟。
...
.下一步是什麼？
在交換器上升級 NX-OS 之後，您需要從 link:configure-install-upgrade-rcf-overview-9332d.html["安裝或升級 RCF 概述"] 開始升級 RCF。
