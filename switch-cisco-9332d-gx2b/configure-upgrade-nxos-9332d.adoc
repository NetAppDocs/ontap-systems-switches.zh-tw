...
summary: 您可以升級 Cisco Nexus 9332D-GX2B 交換器上的 NX-OS，以支援新硬體或 AFX 1K 或 AFX 2K 系統上的新 ONTAP 版本。 
---
= 升級 NX-OS - Cisco Nexus 9332D-GX2B
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
您可以升級 Cisco Nexus 9332D-GX2B 交換器上的 NX-OS，以支援新硬體或 AFX 1K 或 AFX 2K 系統上的新 ONTAP 版本。
