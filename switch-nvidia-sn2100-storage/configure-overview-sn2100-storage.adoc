...
summary: 依照下列工作流程在 ONTAP 環境中安裝和設定 NVIDIA SN2100 儲存設備交換器。 
---
= NVIDIA SN2100 儲存設備交換器的安裝與設定工作流程
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
請依照下列工作流程在 ONTAP 環境中安裝和設定 NVIDIA SN2100 儲存交換器。SN2100 儲存交換器用於在執行 ONTAP 的伺服器和儲存設備陣列之間路由資料。

請依照下列工作流程步驟安裝並設定您的 SN2100 交換器。
