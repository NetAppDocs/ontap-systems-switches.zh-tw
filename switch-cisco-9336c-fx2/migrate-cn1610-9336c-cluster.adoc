...
summary: 將 NetApp CN1610 叢集交換器移轉至 Cisco Nexus 9336C-FX2 和 9336C-FX2-T 叢集交換器，而不中斷叢集運作。 
---
= 將 NetApp CN1610 叢集交換器移轉至 Cisco Nexus 9336C-FX2 和 9336C-FX2-T 叢集交換器
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
將現有的 NetApp CN1610 叢集交換器移轉至 Cisco Nexus 9336C-FX2 和 9336C-FX2-T 叢集交換器，而不中斷叢集運作。
...
有關支援的連接埠及其配置的詳細資訊，請參閱link:https://hwu.netapp.com/["Hardware Universe"^]。如需交換器安裝需求的詳細資訊，請參閱link:https://kb.netapp.com/Support/General_Support/What_additional_information_do_I_need_to_install_my_equipment_that_is_not_in_HWU["安裝HWU中沒有的設備還需要哪些額外資訊？"^]。
