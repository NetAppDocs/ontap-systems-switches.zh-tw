...
summary: 在 Cisco Nexus 9336C-FX2 和 9336C-FX2-T 叢集交換器上安裝或升級 NX-OS 軟體。 
---
= 在 Cisco Nexus 9336C-FX2 和 9336C-FX2-T 叢集交換器上安裝或升級 NX-OS 軟體
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
在 Cisco Nexus 9336C-FX2 和 9336C-FX2-T 叢集交換器上安裝或升級 NX-OS 軟體。必須先安裝 NX-OS，才能設定交換器或安裝參考組態檔案 （RCF）。
