...
summary: 依照以下工作流程在 ONTAP 環境中安裝並設定 Cisco Nexus 9336C-FX2 和 9336C-FX2-T 叢集交換器。 
---
...
[role="lead"]
請依照以下工作流程在 ONTAP 環境中安裝並設定 Cisco Nexus 9336C-FX2 和 9336C-FX2-T 叢集交換器。這些交換器屬於 Cisco Nexus 9000 平台，支援包含兩個以上節點的 ONTAP 叢集。
