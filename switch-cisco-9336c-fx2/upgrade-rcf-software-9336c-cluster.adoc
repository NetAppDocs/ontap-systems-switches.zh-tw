...
summary: 當 Cisco Nexus 9336C-FX2 和 9336C-FX2-T 叢集交換器有新版本可用時，請升級參考組態檔案 （RCF）。 
---
= 升級 Cisco Nexus 9336C-FX2 和 9336C-FX2-T 叢集交換器上的 RCF
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
當 Cisco Nexus 9336C-FX2 和 9336C-FX2-T 叢集交換器有更新版本的 RCF 可用時，請升級參考組態檔案 （RCF）。
...
. 使用下列傳輸協定之一將 RCF 複製到交換器 cs1 上的 bootflash：FTP、SFTP 或 SCP。
+
如需 Cisco 命令的詳細資訊，請參閱 link:https://www.cisco.com/c/en/us/support/switches/nexus-9336c-fx2-switch/model.html#CommandReferences["Cisco Nexus 9000 系列 NX-OS 指令參考"^] 中的適當指南。

+
此範例展示如何使用 SFTP 將 RCF 複製到交換器 cs1 的 bootflash 上：
...
CAUTION: 如果您的 9336C-FX2 交換器在 RCF 升級後無法啟動,請參閱 NetApp 知識庫文章 link:https://kb.netapp.com/on-prem/ontap/OHW/OHW-KBs/Cisco_9336C-FX2_Switch_Fails_to_Boot_After_RCF_Install_%E2%80%93_Boot_Variable_Cleared["Cisco 9336C-FX2 交換器在 RCF 安裝後無法開機 – 開機變數已清除"^] 以了解後續步驟。
