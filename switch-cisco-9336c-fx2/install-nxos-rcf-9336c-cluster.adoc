...
本程序中的範例使用四個節點。這些節點使用兩個10GbE叢集互連連接埠e0a和e0b。請參閱 https://hwu.netapp.com/SWITCH/INDEX["Hardware Universe"] 驗證平台上的叢集連接埠是否正確。
...
.接下來呢？
link:../switch-cisco-9336c-fx2-storage/configure-ssh.html["啟用SSH"]。
