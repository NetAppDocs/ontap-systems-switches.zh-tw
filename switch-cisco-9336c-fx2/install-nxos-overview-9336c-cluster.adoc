...
summary: 在安裝 NX-OS 軟體和參考組態檔案 （RCF） 之前，請準備 Cisco Nexus 9336C-FX2 和 9336C-FX2-T 叢集交換器。 
---
= 準備在 Cisco Nexus 9336C-FX2 和 9336C-FX2-T 叢集交換器上安裝 NX-OS 軟體和 RCF
:allow-uri-read: 


[role="lead"]
在安裝 NX-OS 軟體和參考組態檔案 （RCF） 之前，請先準備 Cisco Nexus 9336C-FX2 和 9336C-FX2-T 叢集交換器。交換器必須先安裝 NX-OS 和 RCF，才能在 ONTAP 叢集中運作。
