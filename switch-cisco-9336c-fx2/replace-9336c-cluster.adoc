...
summary: 更換叢集網路中發生故障的 Cisco Nexus 9336C-FX2 或 9336C-FX2-T 叢集交換器。此為不中斷營運的程序。 
---
...
[role="lead"]
在不中斷叢集運作的情況下，更換叢集網路中發生故障的 Cisco Nexus 9336C-FX2 或 9336C-FX2-T 叢集交換器。此不中斷營運的操作 （NDU） 包括準備一台替換交換器並將連線從故障交換器移轉過來。
