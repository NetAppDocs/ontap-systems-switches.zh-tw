...
summary: 在 Cisco Nexus 9336C-FX2 和 9336C-FX2-T 叢集交換器上完成初始設定後，安裝參考組態檔案 （RCF） 以設定連接埠指派、VLAN 和網路設定。 
---
= 在 Cisco Nexus 9336C-FX2 和 9336C-FX2-T 叢集交換器上安裝 RCF
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
完成初始設定後，在 Cisco Nexus 9336C-FX2 和 9336C-FX2-T 叢集交換器上安裝參考組態檔案 （RCF）。RCF 定義了叢集運作所需的連接埠分配、VLAN 和網路設定。
...
. 使用下列傳輸協定之一將 RCF 複製到交換器 cs1 的 bootflash：FTP、SFTP 或 SCP。
+
