...
summary: 確認 Cisco Nexus 9336C-FX2 叢集交換器上已啟用 SSH 和 SSH 金鑰，以支援 CSHM 和日誌收集。 
---
= 驗證 Cisco Nexus 9336C-FX2 叢集交換器的 SSH 組態
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
確認 Cisco Nexus 9336C-FX2 和 9336C-FX2-T 叢集交換器上已啟用 SSH 和 SSH 金鑰，以支援乙太網路交換器健全狀況監視器 （CSHM） 和日誌收集功能。
