...
summary: 將舊款 Cisco 叢集交換器移轉至 Cisco Nexus 9336C-FX2 和 9336C-FX2-T 叢集交換器，不中斷叢集運作。 
---
= 將舊款 Cisco 交換器移轉至 Cisco Nexus 9336C-FX2 和 9336C-FX2-T 叢集交換器
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
將舊款 Cisco 叢集交換器移轉至 Cisco Nexus 9336C-FX2 和 9336C-FX2-T 叢集交換器，不中斷叢集運作。
