...
summary: 將雙節點無交換器式叢集移轉至使用 NetApp CN1610 叢集交換器的交換式叢集環境。 
---
= 從無交換器式叢集移轉至有交換器的 NetApp CN1610 叢集環境
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
將雙節點無交換器式叢集環境移轉至使用 NetApp CN1610 叢集交換器的有交換器叢集環境。此移轉使叢集能夠擴展到兩個節點以上。
