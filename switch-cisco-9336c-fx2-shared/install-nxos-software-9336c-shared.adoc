...
summary: 在 Cisco Nexus 9336C-FX2 共享的交換器上安裝 NX-OS 軟體，使其為共享的叢集和儲存設備操作做好準備。 
---
= 在 Cisco Nexus 9336C-FX2 共享的交換器上安裝 NX-OS 軟體
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
在 Cisco Nexus 9336C-FX2 共享的交換器上安裝 NX-OS 軟體，使其為共享的叢集和儲存設備操作做好準備。
