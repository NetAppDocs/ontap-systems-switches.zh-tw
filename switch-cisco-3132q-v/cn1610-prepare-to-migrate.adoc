...
.. 下載對應版本的影像處理軟體。
+
https://mysupport.netapp.com/site/products/all/details/cisco-cluster-storage-switch/downloads-tab["Cisco叢集和管理網路交換器參考設定檔下載"^]
...
.下一步是什麼？
做好交換器遷移準備後，您可以…link:cn1610-configure-ports.html["配置您的連接埠"] 。
