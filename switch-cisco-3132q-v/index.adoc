...
[role="lead"]
對於Cisco Nexus 3132Q-V交換器的安裝與維護、請務必檢閱所有要求與建議文件。



== 工作總覽

您可以將Cisco Nexus 3132Q-V交換器當作AFF 叢集交換器、放在您的叢FAS 集或叢集內。安裝與維護工作包括：

* 在Cisco Nexus 3132Q-V叢集交換器上安裝NX-OS和參考組態檔（RCV）。
* 使用Cisco Nexus 3132Q-V叢集交換器、從雙節點無交換式叢集環境移轉至雙節點交換環境。
* 在叢集中更換故障的Cisco Nexus 3132Q-V交換器、然後下載交換器作業系統和參考組態檔。
* 將Cisco Nexus 5596、Nexus 5020或Nexus 5010叢集交換器更換為Cisco Nexus 3132Q-V交換器。
* 使用Cisco Nexus 3132Q-V叢集交換器取代NetApp CN1610交換器。
...
您需要特定的交換器和控制器文件、才能設定3132Q-V交換器和ONTAP 叢集。
