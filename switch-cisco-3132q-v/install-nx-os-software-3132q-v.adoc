...
.建議的文檔
* link:https://mysupport.netapp.com/site/info/cisco-ethernet-switch["Cisco乙太網路交換機"^]。請查閱交換器相容性表格，以了解支援的ONTAP和 NX-OS 版本。
...
. 使用下列傳輸協定之一將 NX-OS 軟體複製到 Nexus 3132Q-V 交換器：FTP、TFTP、SFTP 或 SCP。如需 Cisco 命令的詳細資訊、請參閱 link:https://www.cisco.com/c/en/us/support/switches/nexus-3000-series-switches/products-installation-guides-list.html["Cisco Nexus 3000 系列 NX-OS 指令參考"^] 中的適當指南。
+
.顯示範例
[%collapsible]
====
...
.下一步是什麼？
安裝 NX-OS 軟體後，您可以… link:install-upgrade-rcf-overview-3132q-v.html["安裝或升級參考設定檔（RCF）"]。
