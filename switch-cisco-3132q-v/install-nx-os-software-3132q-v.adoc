...
summary: 在 Cisco Nexus 3132Q-V 叢集交換器上安裝 NX-OS 軟體，使其做好叢集運作的準備。 
---
= 在 Cisco Nexus 3132Q-V 叢集交換器上安裝 NX-OS 軟體
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
在 Cisco Nexus 3132Q-V 叢集交換器上安裝 NX-OS 軟體，使其做好叢集運作的準備。
...
.建議的文檔
* link:https://mysupport.netapp.com/site/info/cisco-ethernet-switch["Cisco 乙太網路交換器"^]。請查閱交換器相容性列表，以了解支援的 ONTAP 和 NX-OS 版本。
* https://www.cisco.com/c/en/us/support/switches/nexus-3000-series-switches/products-installation-guides-list.html["Cisco Nexus 3000 系列交換器"^]。有關 Cisco 交換器升級和降級程序的完整文件，請參閱 Cisco 網站上提供的相應軟體和升級指南。
...
請務必完成 link:prepare-install-cisco-nexus-3132q.html["準備安裝 NX-OS 軟體和 Reference Configuration File"] 中的程序，然後依照下列步驟操作。
...
. 使用下列傳輸協定之一將 NX-OS 軟體複製到 Nexus 3132Q-V 交換器：FTP、TFTP、SFTP 或 SCP。如需 Cisco 命令的詳細資訊、請參閱 link:https://www.cisco.com/c/en/us/support/switches/nexus-3000-series-switches/products-installation-guides-list.html["Cisco Nexus 3000 系列 NX-OS 命令參考"^] 中的適當指南。
+
.顯示範例
[%collapsible]
====
...
.下一步是什麼？
安裝 NX-OS 軟體後，您可以link:install-upgrade-rcf-overview-3132q-v.html["安裝或升級參考設定檔（RCF）"]。
