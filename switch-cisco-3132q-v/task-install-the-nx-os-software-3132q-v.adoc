...
----
. 使用下列傳輸協定之一、將NX-OS軟體複製到Nexus 3132Q-V交換器：FTP、TFTP、SFTP或scp。如需Cisco命令的詳細資訊、請參閱中的適當指南 https://www.cisco.com/c/en/us/support/switches/nexus-3000-series-switches/products-installation-guides-list.html["Cisco Nexus 3000系列NX-OS命令參考資料"^] 指南：
+
本範例顯示使用SFTP將NX-OS軟體複製到Nexus 3132Q-V交換器：
