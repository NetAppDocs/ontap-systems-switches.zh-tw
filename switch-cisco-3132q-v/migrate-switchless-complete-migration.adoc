...
summary: 完成從雙節點無交換器式叢集到 Cisco Nexus 3132Q-V 叢集交換器的移轉。 
---
= 完成從雙節點無交換器式叢集到 Cisco Nexus 3132Q-V 叢集交換器的移轉
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
使用 Cisco Nexus 3132Q-V 叢集交換器，完成從雙節點無交換器式叢集移轉至雙節點有交換器式叢集的最後步驟。
