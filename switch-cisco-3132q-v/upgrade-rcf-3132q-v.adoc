...
+
有關 Cisco 命令的更多資訊，請參閱  https://www.cisco.com/c/en/us/support/switches/nexus-3000-series-switches/products-installation-guides-list.html["Cisco Nexus 3000 系列 NX-OS 指令參考"^] 中的相應指南。
...
NOTE: 有關 RCF 升級後如何使 10GbE 連接埠上線的步驟、請參閱知識庫文章 link:https://kb.netapp.com/onprem%2FSwitches%2FCisco%2F10GbE_ports_on_Cisco_3132Q_cluster_switch_do_not_come_online["Cisco 3132Q 叢集交換器上的 10GbE 連接埠無法連線"^]。



. 驗證 RCF 版本和開關設定正確後，複製 `running-config`文件到 `startup-config`文件。
+
如需 Cisco 命令的詳細資訊、請參閱 link:https://www.cisco.com/c/en/us/support/switches/nexus-3000-series-switches/products-installation-guides-list.html["Cisco Nexus 3000 系列 NX-OS 指令參考"^] 中的適當指南。顯示範例
