...
summary: 確認 Cisco Nexus 9364D-GX2A 交換器上已啟用 SSH，以支援乙太網路交換器健全狀況監視器 （CSHM） 和日誌收集。 
---
= 驗證 Cisco Nexus 9364D-GX2A 交換器上的 SSH 日誌收集功能
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
確認 Cisco Nexus 9364D-GX2A 交換器上已啟用 SSH，以支援乙太網路交換器健全狀況監視器 （CSHM） 和日誌收集功能。
