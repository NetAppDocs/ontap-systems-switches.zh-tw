...
summary: 升級 Cisco Nexus 9364D-GX2A 交換器上的 RCF，以支援 AFX 1K 或 AFX 2K 系統上的新硬體、新的 ONTAP 版本或新的 NX-OS 版本。 
---
= 升級 Cisco Nexus 9364D-GX2A 交換器上的 RCF
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
升級 Cisco Nexus 9364D-GX2A 交換器上的參考組態檔案 （RCF），以支援 AFX 1K 或 AFX 2K 系統上的新硬體、新的 ONTAP 版本或新的 NX-OS 版本。
