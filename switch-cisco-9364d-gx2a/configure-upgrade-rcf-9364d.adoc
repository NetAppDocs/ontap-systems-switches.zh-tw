...
summary: 您可以升級 Cisco Nexus 9364D-GX2A 交換器上的參考組態檔案 （RCF） 版本，以支援新硬體、新的 ONTAP 版本，或與 AFX 1K 或 AFX 2K 系統組態中的新 NX-OS 版本保持一致。 
---
= 升級 RCF 版本 - Cisco Nexus 9364D-GX2A
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
您可以升級 Cisco Nexus 9364D-GX2A 交換器上的參考組態檔案 （RCF） 版本，以支援新硬體、新的 ONTAP 版本，或與 AFX 1K 或 AFX 2K 系統組態中的新 NX-OS 版本保持一致。
...
+
如果您的交換器執行的是 RCF 10.1 或更高版本，則可以link:configure-install-upgrade-rcf-overview-9364d.html#change-port-speed-configuration["更改連接埠速度配置"]（如有需要）。
...
.下一步是什麼？
升級交換器上的 RCF 後，您link:configure-verify-ssh-9364d.html["驗證 SSH 是否用於日誌收集"]。
