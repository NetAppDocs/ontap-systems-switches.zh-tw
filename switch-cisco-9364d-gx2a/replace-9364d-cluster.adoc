...
summary: 在不中斷系統運作的情況下，更換 AFX 系統中發生故障的 Cisco Nexus 9364D-GX2A 交換器。此為不中斷營運的程序。 
---
= 更換 AFX 系統中的 Cisco Nexus 9364D-GX2A 交換器
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
在不中斷系統運作的情況下，更換 AFX 系統中發生故障的 Cisco Nexus 9364D-GX2A 交換器。此不中斷營運的操作 (NDU) 包括準備替換交換器和還原系統組態。
...
** 交換器的初始自訂已完成，詳情請見link:configure-complete-initial-setup-9364d.html["完成初始交換器設置"]。
+
