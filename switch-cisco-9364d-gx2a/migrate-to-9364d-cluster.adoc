...
summary: 您可以將ONTAP叢集的舊Cisco叢集交換器無中斷地遷移到Cisco Nexus 9364d-gx2a 叢集網路交換器。 
---
= 從較舊的Cisco交換器遷移到Cisco Nexus 9364D-GX2A 交換器
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
您可以從較舊的Cisco叢集交換器執行無中斷遷移到Cisco Nexus 9364D-GX2A 叢集網路交換器。
