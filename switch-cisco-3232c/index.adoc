...
[role="lead"]
對於Cisco Nexus 3232C交換器的安裝與維護、請務必檢閱所有要求與建議文件。



== 工作總覽

您可以將Cisco Nexus 3232C交換器當作AFF 叢集交換器、放在您的叢FAS 集或叢集內。安裝與維護工作包括：

* 將Cisco Nexus 3232C交換器（X190100）安裝在NetApp系統機櫃中、並附有交換器隨附的自訂支架、或是以交換器隨附的標準支架安裝在機架中。
* 在Cisco Nexus 3232C叢集交換器上安裝NX-OS軟體和參考組態檔（RCF）。
...
您需要特定的交換器和控制器文件、才能設定Cisco Nexus 3232C交換器和ONTAP 叢集。
