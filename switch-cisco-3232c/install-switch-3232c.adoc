...
* 適用的授權、網路與組態資訊、以及纜線。
* 完全的link:setup-worksheet-3232c.html["佈線工作表"]。
...
* link:required-documentation-3232c.html["所需的交換器和ONTAP 功能文件"] 。
...
.接下來呢？
或者，您可以link:install-cisco-nexus-3232c.html["在NetApp機櫃中安裝Cisco Nexus 3223C 交換機"]。否則，轉到link:cabling-considerations-3232c.html["檢視纜線佈線與組態"]。
