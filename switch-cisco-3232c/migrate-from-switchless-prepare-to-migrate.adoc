...
[role="lead"]
請依照下列步驟準備您的雙節點無交換器式叢集，以移轉到包含 Cisco Nexus 3232C 叢集網路交換器的雙節點交換式叢集。
...
+
如需 Cisco 命令的詳細資訊，請參閱 link:https://www.cisco.com/c/en/us/support/switches/nexus-3000-series-switches/products-command-reference-list.html["Cisco Nexus 3000 系列 NX-OS 命令參考"^] 中的下列清單。
...
.下一步是什麼？
準備好移轉交換器後，您可以link:migrate-from-switchless-configure-ports.html["設定您的連接埠"]。
