...
+
如需 Cisco 命令的詳細資訊，請參閱link:https://www.cisco.com/c/en/us/support/switches/nexus-3000-series-switches/products-command-reference-list.html["Cisco Nexus 3000 系列 NX-OS 指令參考"^]中的適當指南。
