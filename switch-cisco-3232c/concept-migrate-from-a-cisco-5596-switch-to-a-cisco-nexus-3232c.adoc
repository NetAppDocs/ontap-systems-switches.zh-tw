...
summary: 當您將Cisco Nexus 5596叢集交換器更換為Cisco Nexus 3232C叢集交換器時、必須注意特定的組態資訊、連接埠連線和纜線需求。 
---
= 從Cisco Nexus 5596交換器移轉至Cisco Nexus 3232C交換器
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
當您將Cisco Nexus 5596叢集交換器更換為Cisco Nexus 3232C叢集交換器時、必須注意特定的組態資訊、連接埠連線和纜線需求。
