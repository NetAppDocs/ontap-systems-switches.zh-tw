...
請參閱 link:https://hwu.netapp.com/SWITCH/INDEX["Hardware Universe"^] 以確認平台上的叢集連接埠是否正確。如需交換器安裝需求的詳細資訊，請參閱 link:https://kb.netapp.com/Support/General_Support/What_additional_information_do_I_need_to_install_my_equipment_that_is_not_in_HWU["安裝HWU中沒有的設備還需要哪些額外資訊？"^]。
...
.下一步是什麼？
準備好安裝 NX-OS 軟體和 RCF 後，您可以… link:install-nx-os-software-3232c.html["安裝 NX-OS 軟體"]。
