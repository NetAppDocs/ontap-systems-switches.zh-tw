...
. 使用下列傳輸傳輸協定之一、將RCF複製到交換器CS2的bootflash：FTP、TFTP、SFTP或scp。如需Cisco命令的詳細資訊、請參閱中的適當指南 https://["Cisco Nexus 3000系列NX-OS命令參考資料"^] 指南：
+
.顯示範例
[%collapsible]
====
...
+
如需Cisco命令的詳細資訊、請參閱中的適當指南 https://["Cisco Nexus 3000系列NX-OS命令參考資料"^] 指南：
