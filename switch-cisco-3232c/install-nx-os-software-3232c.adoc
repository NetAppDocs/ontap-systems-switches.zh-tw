...
----
====
. 如果您要升級至 NX-OS 版本 9.3(11) 、您必須升級 EPLD `golden` 映像、然後再次重新啟動交換器。否則、請跳至步驟 12 。
+
如需詳細資訊、請參閱 https://www.cisco.com/c/en/us/td/docs/switches/datacenter/nexus9000/sw/93x/epld-rn/nxos_n9K_epldRN_9311.html["EPLD 升級版本資訊、版本 9.3 （ 11 ）"^]。
...
.接下來呢？
安裝完 NX-OS 軟體後，您 link:install-upgrade-rcf-overview-3232c.html["安裝或升級參考設定檔（RCF）"]。
