...
本替換程序中的範例使用四個節點。其中兩個節點使用四個 10 GB 叢集互連連接埠：e0a、e0b、e0c 和 e0d。另外兩個節點使用兩個 40 GB 叢集互連連接埠：e4a 和 e4e。請參閱 link:https://hwu.netapp.com["Hardware Universe"^] 以驗證您平台的正確叢集連接埠。
