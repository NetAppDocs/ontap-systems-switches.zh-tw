...
+
請參閱 link:https://hwu.netapp.com/Home/Index["Hardware Universe"^] 以了解您的平台支援的實際叢集連接埠。請參閱 link:https://kb.netapp.com/Support/General_Support/What_additional_information_do_I_need_to_install_my_equipment_that_is_not_in_HWU["安裝HWU中沒有的設備還需要哪些額外資訊？"^] 以了解交換器安裝要求的更多資訊。
