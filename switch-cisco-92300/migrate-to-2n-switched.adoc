...
summary: 將現有的雙節點無交換器式叢集移轉至使用 Cisco Nexus 92300YC 叢集交換器的交換叢集環境。 
---
= 使用 Cisco Nexus 92300YC 叢集交換器移轉至雙節點交換式叢集
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
使用 Cisco Nexus 92300YC 叢集交換器，將現有的雙節點無交換器式叢集移轉至有交換器叢集環境。這種不中斷營運的移轉可讓您將叢集擴展至兩個節點以上。
