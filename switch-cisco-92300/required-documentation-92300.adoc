...
要設定Cisco Nexus 92300YC 交換機，您需要以下文檔 https://www.cisco.com/site/us/en/products/networking/cloud-networking-switches/nexus-9200-series-switches/index.html["Cisco Nexus 9000系列交換器支援"^]頁：
...
說明與42U系統機櫃相關的FRU、並提供維護與FRU更換指示。
 ...
 a| 
link:install-switch-netapp-cabinet-92300yc.html["在NetApp機櫃中安裝Cisco Nexus 92300YC 交換機"]
 a| 
