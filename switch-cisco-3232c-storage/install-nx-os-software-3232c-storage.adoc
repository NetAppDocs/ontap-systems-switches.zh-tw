...
summary: 在 Cisco Nexus 3232C 儲存設備交換器上安裝或升級 NX-OS 軟體。 
---
= 在 Cisco Nexus 3232C 儲存設備交換器上安裝或升級 NX-OS 軟體
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
在 Cisco Nexus 3232C 儲存設備交換器上安裝或升級 NX-OS 軟體，使其為儲存網路操作做好準備。
...
+
如需詳細資訊，請參閱 https://www.cisco.com/c/en/us/td/docs/switches/datacenter/nexus9000/sw/93x/epld-rn/nxos_n9K_epldRN_9311.html["EPLD Upgrade Release Notes，Release 9.3(11)"^]。
...
----
====
. 如果您是第一次設定交換器，請跳至步驟 15。如果您要升級交換器，請繼續執行下一步。
