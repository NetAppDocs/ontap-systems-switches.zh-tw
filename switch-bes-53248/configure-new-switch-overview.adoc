...
summary: 請依照以下工作流程安裝和設定新的 Broadcom BES-53248 叢集交換器，從審查需求到硬體和軟體設定。 
---
= Broadcom BES-53248 叢集交換器的安裝與設定工作流程
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
請依照下列工作流程在 ONTAP 環境中安裝並設定新的 Broadcom BES-53248 叢集交換器。BES-53248 是一款裸機交換器，支援 2 到 24 個節點的 ONTAP 叢集。
