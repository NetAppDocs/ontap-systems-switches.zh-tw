...
summary: 在 Broadcom BES-53248 叢集交換器上啟用 SSH，以支援乙太網路交換器健全狀況監視器 （CSHM） 和記錄收集功能。 
---
= 在 Broadcom BES-53248 叢集交換器上啟用 SSH
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
在 Broadcom BES-53248 叢集交換器上啟用 SSH，以支援乙太網路交換器健全狀況監視器（CSHM）和日誌收集功能。此步驟包括產生 SSH 金鑰和啟動交換器上的 SSH 存取。
