...
+
這 link:https://hwu.netapp.com/Home/Index["NetApp硬體世界"^] 包含有關ONTAP相容性、支援的 EFOS 韌體以及與 BES-53248 交換器的佈線的資訊。看 link:https://kb.netapp.com/Support/General_Support/What_additional_information_do_I_need_to_install_my_equipment_that_is_not_in_HWU["安裝HWU中沒有的設備還需要哪些額外資訊？"^] 有關交換器安裝要求的詳細資訊。
