...
summary: 完成初始組態後，在 Broadcom BES-53248 叢集交換器上安裝參考組態檔案 （RCF） 和授權檔案。 
---
= 在 Broadcom BES-53248 叢集交換器上安裝 RCF 和授權檔案
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
在 Broadcom BES-53248 叢集交換器上同時安裝參考組態檔案（RCF）和授權檔案。從 EFOS 3.12.0.1 開始，完成交換器初始組態後即可安裝這兩個檔案。
...
* 目前的 RCF 可從 link:https://mysupport.netapp.com/site/products/all/details/broadcom-cluster-switches/downloads-tab["博通集群交換機"^] 頁面取得。
