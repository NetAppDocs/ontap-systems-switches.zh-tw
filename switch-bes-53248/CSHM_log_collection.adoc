...
summary: 在 Broadcom BES-53248 叢集交換器上設定日誌收集，使 CSHM 能夠收集交換器日誌以進行偵錯和 AutoSupport 報告。 
---
= 設定 Broadcom BES-53248 叢集交換器的日誌收集
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
在 Broadcom BES-53248 叢集交換器上設定日誌收集，以啟用乙太網路交換器健全狀況監視器 （CSHM） 收集交換器日誌，用於偵錯和 AutoSupport 報告。此程序可設定隨需支援日誌收集和每小時定期資料收集。
