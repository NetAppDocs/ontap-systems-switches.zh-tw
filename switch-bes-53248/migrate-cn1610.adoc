...
* 將 BS-53248 交換器上的部分連接埠設定為以 10GbE 或 40GbE 執行。
* 從節點到 BS-53248 叢集交換器的 10GbE 與 40GbE 連線能力已規劃、移轉及記錄。
...
----
====
. 將所有叢集節點連線纜線從舊版 CS2 交換器移至新的 CS2 交換器。
. 確認移至 CS2 的網路連線健全狀況：
+
「網路連接埠show -IPSpace Cluster」
...
.更新版本ONTAP
--
對於 ONTAP 9.4 及更早版本、請使用命令： `system cluster-switch delete -device _device-name_`
...
IMPORTANT: 若要啟用記錄收集功能、您必須執行 ONTAP 9.12.1 及更新版本、以及 EFOS 3.8.0.2 及更新版本。
