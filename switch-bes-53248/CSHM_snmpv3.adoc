...
summary: 在 Broadcom BES-53248 叢集交換器上設定 SNMPv3，以啟用與乙太網路交換器健全狀況監視器（CSHM）的安全通訊。 
---
= 為 Broadcom BES-53248 叢集交換器設定 SNMPv3
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
在 Broadcom BES-53248 叢集交換器上設定 SNMPv3，以啟用與乙太網路交換器健全狀況監視器 （CSHM） 的安全的認證通訊。SNMPv3 提供交換器狀態的加密輪詢，用於 ONTAP 中的健全狀況監控。
