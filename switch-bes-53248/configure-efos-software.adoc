...
.開始之前
* 從下載適用於叢集交換器的Broadcom EFOS軟體 https://["Broadcom乙太網路交換器支援"^] 網站。
* 請檢閱下列EFOS版本的相關附註。
...
IMPORTANT: 請注意、將BSP-53248叢集交換器從EFOS 3.3.x.x或3.4.x.x升級至EFOS 3.7.0.4或3.8.0.2之後、交換器間連結（ISL）和連接埠通道會標示為「*向下*」狀態。請參閱以下知識庫文章： https://["BS-53248叢集交換器NDU無法升級至EFOS 3.7.0.4及更新版本"^] 以取得更多詳細資料。
